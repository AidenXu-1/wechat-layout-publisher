...
try {
  ...
  writeFileSync(
    ...
    JSON.stringify({
      ...
      editorial_plan: {
        core_claim: "The announcement matters because it reveals a concrete change in the product direction.",
        reader_question: "What changed, what proves it, and why should a reader care?",
        opening_anchor: "A newly published company announcement changes the expected product behavior.",
        narrative_spine: [
          "show the announcement",
          "explain the exact change",
          "connect the evidence to the reader impact",
          "close with the supported judgment",
        ],
        evidence_sequence: ["the official announcement proves the change exists"],
        ending_claim: "The evidence supports a cautious change in how readers use the product.",
        structure_mode: "hybrid",
        structure_reason: "The event needs a short narrative lead followed by visible explanatory sections.",
        voice_fingerprint: {
          person: "first person observation followed by direct reader explanation",
          register: "plain spoken technical language",
          rhythm: "short lead paragraphs and longer evidence explanations",
          emotional_temperature: "curious and cautious",
          protected_traits: ["direct explanation grounded in visible evidence"],
        },
        revision_priorities: ["put the official evidence next to the claim", "keep the original cautious stance"],
      },
